...
<main class="col-sm-10">
    ...
    <section>
        <div class="row mb-4 pr-4" style="border: 1px solid #dee2e6; background-color: #f4faf4; padding: 15px 0px 10px 5px">     
            <div class="col-sm-11" >
                <span class="span-30" style="color: gray"><!-- <i class="fa fa-users"></i> --> Covid-19 </span><span class="gray">Canais de Atendimento</span>
            </div>
                ...
                <div class="tab-content border border-top-0 bg-white">
                    ...
                    <div class="tab-pane container active" id="tab-1" style="padding-top: 20px; padding-bottom: 1rem; ">
                        ...
                        <form id="form_insert" enctype="multipart/form-data">
                            <input type="hidden" name="tbl" id="tbl" value="canais_atendimento">
                            ...
                            <div class="row" id="row-1">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group input-group-sm mb-3">
                                        ...
                                        <input type="text" name="orgao" id="orgao" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group input-group-sm mb-3">
                                        ...
                                        <input type="text" name="atendimento" id="atendimento" class="form-control" required >
                                    </div>
                                </div> 
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group input-group-sm mb-3">
                                        ...
                                        <input type="text" name="canais" id="canais" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group input-group-sm mb-3">
                                        ...
                                        <input type="text" name="tipo_demanda" id="tipo_demanda" class="form-control" required >
                                    </div>
                                </div> 
