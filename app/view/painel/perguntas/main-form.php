...
<main class="col-sm-10">
    ...
    <section>
        <div class="row mb-4 pr-4" style="border: 1px solid #dee2e6; background-color: #f4faf4; padding: 15px 0px 10px 5px">     
            <div class="col-sm-11" >
                <span class="span-30" style="color: gray"><i class="fa fa-question"></i> Perguntas e Respostas </span>
            </div>
                ...
                <div class="tab-content border border-top-0 bg-white">
                    ...
                    <div class="tab-pane container active" id="tab-1" style="padding-top: 20px; padding-bottom: 1rem; ">
                        ...
                        <form id="form_insert" enctype="multipart/form-data">
                            <input type="hidden" name="tbl" id="tbl" value="perguntas">
                            <!-- ROW 1 -->
                            <div class="row" id="row-1">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea  name="pergunta" id="pergunta" class="form-control" rows="3"></textarea>
                                    </div>
                                </div> 
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea  name="resposta" id="resposta" class="form-control" rows="3"></textarea>
                                    </div>
                                </div> 
                        ...
                        <div class="row">
                            <div id="btn-upload" class="col-9">
                                <button style="display: none" type="button" class="btn btn-secondary btn-sm btn-upload" id="btn-upload-insert"  data-toggle="modal" data-target="#upload-arquivos" disabled><i class="fa fa-cloud-upload"></i> ENVIAR ARQUIVO</button>
                            </div>
                            <div class="col-sm-1">
