<main class="col-md-10" >
    ...
    <section>
        <div class="row">     
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" ><span class="text-muted">Importação</span></div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <h6>Importação de Fases</h6>
                                <form id="formJsonFases">
                                    <div class="row">                    
                                        <div class="col-md-8">
                                            <div class="form-group">
                                              <input type="file" class="form-control-file" id="jsonFile" name="jsonFile" accept=".json">
                                        ...
                                        <div class="col-md-3">
                                            <button type="button" class="btn btn-sm btn-secondary" onclick="importarJsonFases()">
                                                <i class="fa fa-file-text-o"></i>
                                                Importar
                                            </button>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <h6>Importação de Autores</h6>
                                <form id="formJsonAutores">
                                    <div class="row">                    
                                        <div class="col-md-8">
                                            <div class="form-group">
                                              <input type="file" class="form-control-file" id="jsonFile" name="jsonFile" accept=".json">
                                        ...
                                        <div class="col-md-3">
                                            <button type="button" class="btn btn-sm btn-secondary" onclick="importarJsonAutores()">
                                                <i class="fa fa-file-text-o"></i>
                                                Importar
                                            </button>
                                        </div>
