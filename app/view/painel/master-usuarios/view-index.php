<main class="col-md-10" >
                        ...
                        <div class="row" id="row-1">
                            ...
                            <div class="col-md-3">
                                <div class="input-group  input-group-sm mb-3">
                                    ...
                                    <input type="text" name="c3"  id="c3" class="form-control" placeholder="Login">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="input-group  input-group-sm mb-3">
                                    ...
                                    <input type="text" name="c4"  id="c4" class="form-control" placeholder="Email">
                                </div>
                            </div>
    ...
    <div class="row" style="padding: 15px">     
        ...
        <div class="col-md-12 bg-white border reset">
            <div class="row">
                <div class="col-sm-10 reset"></div>
