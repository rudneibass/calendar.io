...
<main class="col-md-10">
    ...
    <section>
        <div class="row mb-3 pr-3" style="border: 1px solid #dee2e6; background-color: #f4faf4; padding: 15px 0px 10px 5px">     
            <div class="col-md-11" >
                <span class="span-30" style="color: gray"><i class="fa fa-users"></i> Mandatos / Legislaturas </span>
            </div>
                ...
                <div class="tab-content bg-white border border-top-0">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-light border" role="alert">
                                    <i class="fa fa-users"></i> <i><b>Dados do Básicos</b></i>
                                    &emsp;
                    ...
                    <div class="tab-pane fade" id="tab-2" style="padding: 20px;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert alert-light border" role="alert">
                                        <i class="fa fa-users"></i> <i><b>Membros do Mandato</b></i>
                                    </div>
                                </div>
                            </div>

                            <form id="tab-2-form-1" enctype="multipart/form-data">
                            <input type="hidden" value="mandatos_detalhe" name="tbl" id="tbl">                              
                            <!-- ROW 1 -->
                            <div class="row">
