...
<main class="col-md-10">
    ...
    <section>
        <div class="row mb-3 pr-3" style="border: 1px solid #dee2e6; background-color: #f4faf4; padding: 15px 0px 10px 5px">     
            <div class="col-md-11" >
                <span class="span-30" style="color: gray"><i class="fa fa-table"></i> Mesa Diretora </span>
            </div>
                ...
                <div class="tab-content bg-white border border-top-0">
                    ...
                    <div class="tab-pane active" id="tab-1" style="padding: 20px;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-light border" role="alert">
                                    <i class="fa fa-table"></i> <i><b>Mesa Diretora</b></i>
                                    &emsp;
                        ...
                        <form id="tab-1-form-1">
                            <div>
                                <input type="hidden" name="tbl" id="tbl" value="mesa_diretora">
                    ...
                    <div class="tab-pane fade" id="tab-2" style="padding: 20px;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-light border" role="alert">
                                    <i class="fa fa-users"></i> <i><b>Membors da Mesa Diretora</b></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <form id="tab-2-form-1" enctype="multipart/form-data">
                            <input type="hidden" value="mesa_diretora" name="tbl" id="tbl">                              
                            <!-- ROW 1 -->
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control"  name="id_mesa_diretora" id="relacionamento" readonly="true">
                                    </div>
                                </div>
