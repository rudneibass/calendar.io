<main class="col-md-10">
    ...
    <section>
        <div class="row mb-3 pr-3" style="border: 1px solid #dee2e6; background-color: #f4faf4; padding: 15px 0px 10px 5px">
            <div class="col-md-11">
                <span class="span-30" style="color: gray"><i class="fa fa-laptop"></i> Links </span>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-light border" role="alert">
                                <i class="fa fa-laptop"></i> <i><b>Url de Integração com Portais</b></i>
                                &emsp;
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label>Link </label><span style="color: #c0c0c0"> (Inserir link com http:// ou https://)</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="tipo" name="tipo" class="form-control">
                                        ...
                                        <optgroup label="Trânsparencia">
                                            <option value="redirecionamento"> Link de Redirecionamento</option>
                                            <option value="despesas-extra"> Despesas Extra</option>
                                            <option value="detalhamento-pessoal"> Detalhamento Pessoal</option>
                                            <option value="empenhos"> Empenhos</option>
                                            <option value="liquidacoes"> Liquidações</option>
                                            <option value="pagamentos"> Pagamentos</option>
                                            <option value="previsao-e-arrecadacao"> Previsão e Arrecadação</option>
                                            <option value="prestacao-de-contas"> Prestação de Contas</option>
                                            <option value="receita-lancamentos"> Receita - Lançamentos</option>
                                            <option value="receitas-extra"> Receitas Extra</option>
