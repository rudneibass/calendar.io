<main class="col-md-10" >
    <section>
        <div class="row mb-3 pr-3" style="border: 1px solid #dee2e6; background-color: #f4faf4; padding: 15px 0px 10px 5px">     
            <div class="col-md-11">
                <span class="span-30" style="color: gray"><i class="fa fa-newspaper-o"></i> Noticias </span>
            </div>
        ...
        <div class="row">     
            <div class="col-md-12">
                <div class="card">
                            ...
                            <div class="row" id="row-1">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group  input-group-sm mb-3">
                                        ...
                                        <input type="text" name="c2"  id="c2" class="form-control" placeholder="Trecho da notícia...">
                                    </div>
                                </div>
                    ...
                    <div class="d-flex justify-content-between p-2 border-top-0">
                        <div>
                        <button type="button" class="btn btn-success btn-sm"  onclick="ativarTodos()" >
                                <i class="fa fa-mouse-pointer"></i> Colocar Todos no Ar
                            </button>
                            <button type="button" class="btn btn-danger btn-sm ml-2"  onclick="desativarTodos()" >
                                <i class="fa fa-mouse-pointer"></i> Tirar Todos do Ar
                            </button>
                        </div>
                        <div>
