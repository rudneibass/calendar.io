<main class="col-md-10">
    ...
    <div class="row mb-3 pr-3" style="border: 1px solid #dee2e6; background-color: #f4faf4; padding: 15px 0px 10px 5px">     
        <div class="col-md-11" >
            <span class="span-30" style="color: gray"><i class="fa fa-file-text-o"></i> Diárias </span>
        </div>
        ...
        <div class="tab-content bg-white border border-top-0">
            ...
            <div class="tab-pane active" id="tab-1" style="padding: 20px;">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-light border" role="alert">
                            <i class="fa fa-file-text-o"></i><i><b> Dados da Diária</b></i>
                            &emsp;
                ...
                <form id="tab-1-form-1">
                    <div>
                        <input type="hidden" value="diarias" name="tbl" id="tbl">	
                        ...
                        <div class="row" id="row-1">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="data_diaria" id="data_diaria"  class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>
                                        Beneficiario<span id="asterisco" style="color:#F00">*</span> 
                                    </label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>
                                        Orgão/Empresa<span id="asterisco" style="color:#F00">*</span> 
                                    </label>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>
                                        Cidade<span id="asterisco" style="color:#F00">*</span> 
                                    </label>
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label>
                                        UF<span id="asterisco" style="color:#F00">*</span> 
                                    </label>
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label>
                                        Qtde<span id="asterisco" style="color:#F00">*</span> 
                                    </label>
                                    <input type="text" name="quantidade" id="quantidade"  class="form-control" onblur="number('quantidade')" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label>
                                        Vl. Unit.<span id="asterisco" style="color:#F00">*</span> 
                                    </label>
                                    <input type="text"  name="valor_unitario" id="valor_unitario"  class="form-control"  onblur="valorTotal()" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label>
                                        Total<span id="asterisco" style="color:#F00">*</span> 
                                    </label>
                                    <input type="text" name="valor_total" id="valor_total"  class="form-control" onblur="number('valor_total')" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>
                                        Data Quitação<span id="asterisco" style="color:#F00">*</span> 
                                    </label>
                                    <input type="date" name="data_quitacao" id="data_quitacao"  class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>
                                        Descrição<span id="asterisco" style="color:#F00">*</span> 
                                    </label>
            ...
            <div class="tab-pane fade" id="tab-2" style="padding: 20px;">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-light border" role="alert">
                         <i class="fa fa-file-text-o"></i><i><b> Arquivos da Diária</b></i>
                        </div>
                    </div>
                </div>
