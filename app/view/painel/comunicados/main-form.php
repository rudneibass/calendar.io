...
<main class="col-sm-10">
    ...
    <section>
        <div class="row mb-4 pr-4" style="border: 1px solid #dee2e6; background-color: #f4faf4; padding: 15px 0px 10px 5px">     
            <div class="col-sm-11" >
                <span class="span-30" style="color: gray"><!-- <i class="fa fa-users"></i> --> Covid-19 </span><span class="gray">Comunicados</span>
            </div>
                ...
                <div class="tab-content border border-top-0 bg-white">
                    ...
                    <div class="tab-pane container active" id="tab-1" style="padding-top: 20px; padding-bottom: 1rem; ">
                        ...
                        <form id="form_insert" enctype="multipart/form-data">
                            <input type="hidden" name="tbl" id="tbl" value="comunicados">
                            <!-- ROW 1 -->
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" id="tipo" name="tipo">
                                            ...
                                            <option value="nr">Notas de Recomendação</option>
                                            <option value="bi">Boletim Informativo</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div id="btn-upload" class="col-9">
                                <button type="button" class="btn btn-secondary btn-sm btn-upload" id="btn-upload-insert"  data-toggle="modal" data-target="#upload-arquivos" disabled><i class="fa fa-cloud-upload"></i> ENVIAR ARQUIVO</button>
                            </div>
                            <div class="col-sm-1">
