            ...
            <div class="modal-content border" style="background:rgba(0, 0, 0, 0.5);">
                <div class="modal-body" style="background:rgba(0, 0, 0, 0.5); text-align: center;">
                    ...
                    <h2 style="color: white">
                        Você está realmente a favor dessa matéria?
                    </h2>
                    <br />
                    <div class="align-center d-flex" >
                        ...
                        <button 
                            type="button" 
                            class="btn btn-success btn-lg btn3d m-auto"
                            onclick="votar({id_servidor: <?php echo $_SESSION['USUARIO_ID']; ?>, id_materias: <?php echo $emVotacao->materia['id_materias'] ?>, voto: 'S'})"
                        >
                            <i class="fa fa-check"></i>&nbsp;A Favor
                        </button>
                    </div>
                    <br />
                </div>
