...
<body
    ...
    <div style="background:rgba(55, 59, 62, 0.8); height: 100vh">
        ...
        <main>
            ...
            <?php require_once('componentes/em-votacao.php') ?>
            <?php require_once('componentes/botoes.php') ?>
        </main>

        <?php require_once('componentes/footer.php') ?>
        <?php require_once('componentes/modal-detalhes.php') ?>
        <?php require_once('componentes/modal-aprovar.php') ?>
        <?php require_once('componentes/modal-rejeitar.php') ?>
        <?php require_once('componentes/modal-abster.php') ?>
        <?php require_once('componentes/modal-voto-sucesso.php') ?>
    </div>
</body>
<script>
    /*
...
<script>
        function votar({id_servidor, id_materias, voto}) {
            $.ajax({
                url: '../../../app/view/votacao/pwa/index.php',
                type: 'POST',
                dataType: "json",
                data: {
                    id_servidor, 
