...
class ControllerComissoes {

    function teste() {
        echo 'function teste() Controller comissoes Controller';
    }
    ...
    function locate() {
        ...
        if (isset($_POST['id'])) {
            ...
            $crud = new ClassModel();
            $select = $crud->select('*, e.id as relacionamento  ', 'comissoes e', $prep, array());
            ...
            $crud = new ClassModel();
            $select = $crud->select("*, DATE_FORMAT(data_cadastro, '%d/%m/%Y') as data_cadastro", 'comissoes ', $prep, array());
    ...
    public function update() {
        ...
        if ($val->validar()) {
            ...
            $crud = new ClassModel();
            $update = $crud->update('comissoes ', $post, $id);
        } else {
    ...
    public function insert() {
        ...
        if ($val->validar()) {
            ...
            $crud = new ClassModel();
            print $crud->insert($post, 'comissoes ');
        } else {
            foreach ($val->getErrors() as $erro) {
                echo "$erro <br />";
            }
    ...
    /*public function delete() {
        ...
        if ($val->validar()) {
            ...
            $crud = new ClassModel();
            $delete = $crud->delete('comissoes ', ' WHERE id=?', array($id));
        } else {
            foreach ($val->getErrors() as $erro) {
                echo "$erro <br />";
            }
