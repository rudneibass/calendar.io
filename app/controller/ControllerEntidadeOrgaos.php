...
class ControllerEntidadeOrgaos {
    ...
    function locate() {
        ...
        if (isset($_POST['id'])) {
            ...
            $crud = new ClassModel();
            $select = $crud->select('*, e.id as relacionamento  ', 'entidade_orgaos e', $prep, array());
            ...
            $crud = new ClassModel();
            $select = $crud->select("*, DATE_FORMAT(data_cadastro, '%d/%m/%Y') as data_cadastro", 'entidade_orgaos ', $prep, array());
    ...
    public function update() {
        ...
        $val->set($_POST['id_entidade'], '<b>Entidade</b>')->obrigatorio();
        ...
        if ($val->validar()) {
            ...
            $crud = new ClassModel();
            $update = $crud->update('entidade_orgaos ', $post, $id);
        } else {
    ...
    public function insert() {
        ...
        if ($val->validar()) {
            ...
            $crud = new ClassModel();
            print $crud->insert($post, 'entidade_orgaos ');
        } else {
            foreach ($val->getErrors() as $erro) {
                echo "$erro <br />";
            }
    ...
    /*public function delete() {
        ...
        if ($val->validar()) {
            ...
            $crud = new ClassModel();
            $delete = $crud->delete('entidade_orgaos ', ' WHERE id=?', array($id));
        } else {
            foreach ($val->getErrors() as $erro) {
                echo "$erro <br />";
            }
