...
class ControllerComunicados {

    function teste() {
        echo 'function teste() ControllerComunicados Controller';
    }
    ...
    function locate() {
        ...
        if (isset($_POST['id'])) {
            ...
            $crud = new ClassModel();
            $select = $crud->select('* ', 'comunicados ', $prep, array());
            ...
            $crud = new ClassModel();
            $select = $crud->select("*, DATE_FORMAT(data, '%d/%m/%Y') as data", 'comunicados ', $prep, array());
    ...
    public function update() {
        ...
        $val->set($_POST['nome'], '<b>"Titulo"</b>')->obrigatorio();
        ...
        if ($val->validar()) {
            ...
            $crud = new ClassModel();
            $update = $crud->update('comunicados ', $post, $id);
        } else {
    ...
    public function insert() {
        ...
        if ($val->validar()) {
            ...
            $crud = new ClassModel();
            print $crud->insert($post, 'comunicados ');
        } else {
            foreach ($val->getErrors() as $erro) {
                echo "$erro <br />";
            }
    ...
    /*public function delete() {
        ...
        if ($val->validar()) {
            ...
            $crud = new ClassModel();
            $delete = $crud->delete('comunicados ', ' WHERE id=?', array($id));
        } else {
            foreach ($val->getErrors() as $erro) {
                echo "$erro <br />";
            }
