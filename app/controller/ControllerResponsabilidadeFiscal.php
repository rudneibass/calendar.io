...
class ControllerResponsabilidadeFiscal {
    ...
    function locate() {
        ...
        if (isset($_POST['id'])) {
            ...
            $crud = new ClassModel();
            $select = $crud->select('*, e.id as relacionamento  ', 'responsabilidade e', $prep, array());
            ...
            $crud = new ClassModel();
            $select = $crud->select("*, DATE_FORMAT(data_cadastro, '%d/%m/%Y') as data_cadastro", 'responsabilidade ', $prep, array());
    ...
    public function update() {
        ...
        $val->set($_POST['descricao'], '<b>Descricao</b>')->obrigatorio();
        ...
        if ($val->validar()) {
            ...
            $crud = new ClassModel();
            $update = $crud->update('responsabilidade ', $post, $id);
        } else {
    ...
    public function insert() {
        ...
        $val = new ClassValidacao();
        $val->set($_POST['descricao'], '<b>Descricaoe</b>')->obrigatorio();
        ...
        if ($val->validar()) {
            ...
            $post['usuario'] = $_SESSION['USUARIO'];
            $crud = new ClassModel();
            print $crud->insert($post, 'responsabilidade ');
        } else {
            foreach ($val->getErrors() as $erro) {
                echo "$erro <br />";
            }
    ...
    /*public function delete() {
        ...
        if ($val->validar()) {
            ...
            $crud = new ClassModel();
            $delete = $crud->delete('responsabilidade ', ' WHERE id=?', array($id));
        } else {
            foreach ($val->getErrors() as $erro) {
                echo "$erro <br />";
            }
