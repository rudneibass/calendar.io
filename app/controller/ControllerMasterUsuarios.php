...
class ControllerMasterUsuarios {
    ...
    function locate() {
        ...
        if (isset($_POST['id'])) {
            ...
            $select = $crud->select('*', 'master_master_usuarios ', $prep, array());
            ...
            $crud = new MasterClassModel();
            $select = $crud->select('*', 'master_usuarios ', $prep, array());
    ...
    public function update() {
        ...
        if ($val->validar()) {
            ...
            if ($_SESSION['captcha'] == $_POST['captcha']) {
                ...
                $crud = new MasterClassModel();
                $update = $crud->update('master_usuarios ', $post, $id);
            } else {
    ...
    public function insert() {
        ...
        if ($val->validar()) {
            ...
            if ($_SESSION['captcha'] == $_POST['captcha']) {
                $crud = new MasterClassModel();
                $crud->Insert($post, 'master_usuarios');
            } else {
    ...
    /*public function delete() {
        ...
        if ($val->validar()) {
            ...
            $crud = new MasterClassModel();
            $delete = $crud->delete('master_usuarios', ' WHERE id=?', array($id));
        } else {
            foreach ($val->getErrors() as $erro) {
                echo "$erro <br />";
            }
