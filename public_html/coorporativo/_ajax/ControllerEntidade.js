...
function populaForm(id) {
    ...
    $.ajax({
        ...
        url: '../../_php/Dispatch.php?controller=ControllerMasterEntidade&&action=locate',
...
function locate() {
    ...
    $('#thead').append(
            ...
            .append($('<th>').append('cnpj'))
            
            .append($('<th>').append('Manutenção'))
...
//                    var tbody = $('table > tbody');
                    ...
                    for (var i = pagina * tamanhoPagina; i < retorno.length && i < (pagina + 1) * tamanhoPagina; i++) {
                        ...
                        $("#tbody").append(
                                ...
                                .append($('<td>').append(retorno[i].razao_social))

                                .append($('<td>').append(retorno[i].cnpj))

                                .append($('<td style="width: 5%">').append(retorno[i].manutencao))
...
function  update(id) {
    ...
    $.ajax({
        ...
        url: '../../_php/Dispatch.php?controller=ControllerMasterEntidade&&action=update&&id=' + id,
...
function insert() {
    ...
    $.ajax({
        ...
        url: '../../_php/Dispatch.php?controller=ControllerMasterEntidade&&action=insert',
...
function deletar(id) {
    ...
    if (confirm("TEM CERTEZA QUE DESEJA EXCLUIR ESSE REGISTRO?")) {
        ...
        $.ajax({
            ...
            url: '../../_php/Dispatch.php?controller=ControllerMasterEntidade&&action=delete',
