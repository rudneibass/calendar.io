...
<!--                                    <img src="../img/logo-w2e.png" class="img-thumbnail" >-->
                            ...
                            <form id="login">  
                                ...
                                <input type="hidden" id="cnpj" name="cnpj" value="07616162000106">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group input-group-sm mb-3">
                                        <button class="btn btn-primary btn-block btn-flat btn-sm" onclick="login()"> <i class="fa fa-unlock-alt"></i> Acessar </button>
                                    </div>
                                </div>
                            </div><!-- .row -->
