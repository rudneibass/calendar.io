...
<html lang="pt-br">
    ...
    <body style="background-color: #FAFBFC;">
        ...
        <div class="container-fluid">
            <div class="row full-screen">
                ...
                $render->renderMain('diarias','view-cadastro'); 
    ...
    $render->renderScripts(array('Diarias', 'OptionSelect', 'Upload', 'ListarArquivos', 'EntidadeInfo'));
    ...
    if($id){ 
        ...
        $render->renderScriptsOnload(array('ListarArquivos' => array($id, 'diarias')));
    }
