...
<body
    ...
    <div style="background:rgba(55, 59, 62, 0.8); height: 100vh">
        ...
        <main>
            <?php require_once('em-votacao.php') ?>
            <?php require_once('botoes.php') ?>
        </main>

        <?php require_once('footer.php') ?>

        <?php require_once('modal-detalhes.php') ?>
        <?php require_once('modal-aprovar.php') ?>
        <?php require_once('modal-rejeitar.php') ?>
        <?php require_once('modal-abster.php') ?>
    </div>
</body>
<script>
