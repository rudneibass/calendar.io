...
<html lang="pt-br">
    ...
    <body style="background-color: #FAFBFC;">
        ...
        <div class="container-fluid">
            <div class="row full-screen">
                ...
                $render->renderMain('opcoes-tabelas-colunas','view-cadastro'); 
                $render->renderFooter();
    ...
    $render->renderScripts(array('OpcoesTabelasColunas', 'OptionSelect', 'EntidadeInfo')); 
    $render->renderScriptsOnload(array('razaoSocial' => array('')));
    $render->renderScriptsOnload(array('optionSelectTabelas' => array('_tables')));
