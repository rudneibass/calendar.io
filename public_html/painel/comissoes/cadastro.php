...
<html lang="pt-br">
    ...
    <body style="background-color: #FAFBFC;">
        ...
        <div class="container-fluid">
            <div class="row full-screen">
                ...
                $render->renderMain('comissoes','view-cadastro'); 
                $render->renderFooter();
    ...
    $render->renderScripts(array('Comissoes', 'ComissoesMembros', 'OptionSelect', 'EntidadeInfo')); 
    $render->renderScriptsOnload(array('razaoSocial' => array('')));
    $render->renderScriptsOnload(array('optionSelect' => array('servidor')));
    $render->renderScriptsOnload(array('optionSelect' => array('legislaturas')));
