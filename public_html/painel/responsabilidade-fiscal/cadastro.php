...
<html lang="pt-br">
    ...
    <body style="background-color: #FAFBFC;">
        ...
        <div class="container-fluid">
            <div class="row full-screen">
                ...
                $render->renderMain('responsabilidade-fiscal','view-cadastro'); 
    ...
    $render->renderScripts(array('ResponsabilidadeFiscal', 'OptionSelect', 'Upload', 'ListarArquivos')); 
    $render->renderScriptsOnload(array('ListarArquivos' => array($id, 'responsabilidade')));
