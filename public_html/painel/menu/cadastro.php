...
<html lang="pt-br">
    ...
    <body style="background-color: #FAFBFC;">
        ...
        <div class="container-fluid">
            <div class="row full-screen">
                ...
                $render->renderMain('menu','view-cadastro'); 
                $render->renderFooter();
    ...
    $render->renderScripts(array('Menu', 'EntidadeInfo', 'OptionSelect')); 
    $render->renderScriptsOnload(array('razaoSocial' => array('')));
    $render->renderScriptsOnload(array('optionSelect' => array('menus')));
