...
<html lang="pt-br">
    <head>
        ...
        if (file_exists('../../../config/sec.php')) {
            ...
            echo '<b>ATENÇÃO: </b>Não foi possivel localizar sec.php em public_html/painel/comunicados/cadastrar.php!';
        }

        if (file_exists('../_html/tags-meta.html')) {
            include_once ('../_html/tags-meta.html');
        } else {
            echo '<b>ATENÇÃO: </b>Não foi possivel localizar tags-meta.html em public_html/painel/comunicados/cadastrar.php!';
        }

        if (file_exists('../_html/tags-link.html')) {
            include_once ('../_html/tags-link.html');
        } else {
            echo '<b>ATENÇÃO: </b>Não foi possivel localizar tags-link.html em public_html/painel/comunicados/cadastrar.php!';
        }
        ?>
    </head>
    <body style="background-color: #FAFBFC;">
        ...
        <div class="container-fluid">
            <div class="row full-screen">
                ...
                if (file_exists('../_html/modal-files.html')) {
                    include ('../_html/modal-files.html');
                } else {
                    echo "<b>Atenção:</b> Não foi possviel localizar elemento <b>modal-upload</b>!";
                }
                ?>   
    ...
    if (file_exists('../_html/tags-script.html')) {
        ...
        echo '<b>ATENÇÃO: </b>Não foi possivel localizar tags-script.html em public_html/painel/comunicados/cadastrar.php!';
    }
    ?>
