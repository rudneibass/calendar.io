...
<html lang="pt-br">
    ...
    <body style="background-color: #FAFBFC;">
        ...
        <div class="container-fluid">
            <div class="row full-screen">
                ...
                $render->renderMain('portarias','view-cadastro'); 
    ...
    $render->renderScripts(array('Portarias', 'OptionSelect', 'Upload', 'ListarArquivos')); 
    $render->renderScriptsOnload(array('ListarArquivos' => array($id, 'portarias')));
