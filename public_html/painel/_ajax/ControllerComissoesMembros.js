function insertTab2Form1() {
    $.ajax({
        url: '../../_php/Dispatch.php?controller=ControllerComissoesMembros&&action=insert',
        type: 'POST',
...
function locateTab2Form1(id) {
    ...
    $.ajax({
        url: '../../_php/Dispatch.php?controller=ControllerComissoesMembros&&action=locate',
        cache: false,
        type: 'POST',
        data: {id: id},
        dataType: "json",
...
function populaFormTab2Form1(id) {
    $.ajax({
        url: '../../_php/Dispatch.php?controller=ControllerComissoesMembros&&action=locate&&id=' + id,
        type: 'POST',
        dataType: "json",
        data: {id: id},
...
function  updateTab2Form1(id) {
    $.ajax({
        url: '../../_php/Dispatch.php?controller=ControllerComissoesMembros&&action=update&&id=' + id,
        type: 'POST',
        data: $('#tab-2-form-1').serialize(),
        beforeSend: function () {
...
function deletarTab2Form1(id) {
    if (confirm("\u{26A0}\u{FE0F} TEM CERTEZA QUE DESEJA EXCLUIR ESSE REGISTRO?")) {
        $.ajax({
            url: '../../_php/Dispatch.php?controller=ControllerComissoesMembros&&action=delete',
            type: "POST",
            data: {id: id},
            success: function (data) {
                $("#linha" + id).remove();
