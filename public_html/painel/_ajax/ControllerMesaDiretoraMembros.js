function insertTab2Form1() {
    $.ajax({
        url: '../../_php/Dispatch.php?controller=ControllerMesaDiretoraMembros&&action=insert',
        type: 'POST',
...
function locateTab2Form1(id) {
    ...
    $.ajax({
        url: '../../_php/Dispatch.php?controller=ControllerMesaDiretoraMembros&&action=locate',
        cache: false,
        type: 'POST',
        data: {id: id},
        dataType: "json",
...
function populaFormTab2Form1(id) {
    $.ajax({
        url: '../../_php/Dispatch.php?controller=ControllerMesaDiretoraMembros&&action=locate&&id=' + id,
        type: 'POST',
        dataType: "json",
        data: {id: id},
...
function  updateTab2Form1(id) {
    $.ajax({
        url: '../../_php/Dispatch.php?controller=ControllerMesaDiretoraMembros&&action=update&&id=' + id,
        type: 'POST',
        data: $('#tab-2-form-1').serialize(),
        beforeSend: function () {
