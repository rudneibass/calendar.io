function insertTab2Form1() {
    $.ajax({
        url: '../../_php/Dispatch.php?controller=ControllerLicitacoesFases&&action=insert',
        type: 'POST',
...
function locateTab2Form1(id) {
    $("#tab-2-tbody-1").empty();
    $.ajax({
        url: '../../_php/Dispatch.php?controller=ControllerLicitacoesFases&&action=locate',
        cache: false,
        type: 'POST',
        data: {id: id},
        dataType: "json",
        ...
        success: function (retorno) {
            if (!retorno[0]) {
                $("#tab-2-echos-1").html("<h6 class='text-muted text-center'>Não há fase cadastrada!</h6>");
            } else {
...
function populaFormTab2Form1(id) {
    $.ajax({
        url: '../../_php/Dispatch.php?controller=ControllerLicitacoesFases&&action=locate&&id=' + id,
        type: 'POST',
        dataType: "json",
        data: {id: id},
...
function  updateTab2Form1(id) {
    $.ajax({
        url: '../../_php/Dispatch.php?controller=ControllerLicitacoesFases&&action=update&&id=' + id,
        type: 'POST',
        data: $('#tab-2-form-1').serialize(),
        beforeSend: function () {
