...
<html lang="pt-br">
    ...
    <body style="background-color: #FAFBFC;">
        ...
        <div class="container-fluid">
            <div class="row full-screen">
                ...
                $render->renderMain('licitacoes','view-cadastro'); 
    ...
    $render->renderScripts(array('Licitacoes', 'LicitacoesFases', 'OptionSelect', 'Upload', 'ListarArquivos', 'EntidadeInfo')); 
    $render->renderScriptsOnload(array('ListarArquivos' => array($id, 'licitacoes')));
