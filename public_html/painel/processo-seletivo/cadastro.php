...
<html lang="pt-br">
    ...
    <body style="background-color: #FAFBFC;">
        ...
        <div class="container-fluid">
            <div class="row full-screen">
                ...
                $render->renderMain('processo-seletivo','view-cadastro'); 
    ...
    $render->renderScripts(array('ProcessoSeletivo', 'ProcessoSeletivoFases', 'OptionSelect', 'Upload', 'ListarArquivos')); 
    $render->renderScriptsOnload(array('ListarArquivos' => array($id, 'processo_seletivo')));
