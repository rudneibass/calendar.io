...
<body style="background-color: #FAFBFC;">
    ...
    <div class="container-fluid">
        <div class="row full-screen">
            <?php
            $render->renderMain('noticias', 'view-cadastro');
            $render->renderModal(array('modal-upload-preview-imagem', 'modal-upload'));
            $render->renderFooter();
            ?>
        </div><!-- full screen  -->
    </div><!-- container-fluid -->
...
<?php
$render->renderScripts(array('Noticias', 'OptionSelect', 'UploadImagem', 'Upload', 'ListarArquivos', 'EntidadeInfo'));
