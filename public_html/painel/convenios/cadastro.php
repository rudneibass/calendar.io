...
<html lang="pt-br">
    ...
    <body style="background-color: #FAFBFC;">
        ...
        <div class="container-fluid">
            <div class="row full-screen">
                ...
                $render->renderMain('convenios','view-cadastro'); 
    ...
    $render->renderScripts(array('Convenios', 'OptionSelect', 'Upload', 'ListarArquivos', 'EntidadeInfo')); 
    ...
    $render->renderScriptsOnload(array('ListarArquivos' => array($id, 'convenios')));
