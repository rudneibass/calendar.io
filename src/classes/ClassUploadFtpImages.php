...
class ClassUploadFtpImages
{
    ...
    public function uploadFtp($nome_arquivo, $arquivo_temp)
    {
        ...
        $novo_arquivo_url = $this->dir_imagens. $this->cnpj . '/' . $nome_arquivo;
        ...
        $arrayDiretorios = ftp_nlist($conexao_ftp, $this->dir_imagens);
        ...
        if (!in_array($this->cnpj, $arrayDiretorios)) {
            ...
            if(ftp_chdir($conexao_ftp, $this->dir_imagens)){
                //CRIA O SUBDIRETÓRIO
